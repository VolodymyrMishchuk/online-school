...
default NotificationEntity createNotification(UUID recipientId,String title,String message,NotificationType type){return createNotification(recipientId,title,message,type,null);}

void broadcastToAdmins(String title,String message,NotificationType type,String buttonUrl);

default void broadcastToAdmins(String title,String message,NotificationType type){broadcastToAdmins(title,message,type,null);}

void sendToAllUsers(String title,String message,String buttonUrl);

default void sendToAllUsers(String title,String message){sendToAllUsers(title,message,null);}

void sendToUsers(String title,String message,java.util.List<UUID>userIds,String buttonUrl);

default void sendToUsers(String title,String message,java.util.List<UUID>userIds){sendToUsers(title,message,userIds,null);}
