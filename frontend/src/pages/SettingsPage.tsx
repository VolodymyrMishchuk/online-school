                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
                    ...
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-brand-primary focus:ring-2 focus:ring-brand-light outline-none transition-all bg-gray-50 focus:bg-white"
                                />
                            </div>
                            <div>
                                <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-2">
                        ...
                        <div>
                            ...
                            <button
                                ...
                                className="px-4 py-2 text-sm rounded-xl bg-gray-50 text-brand-primary font-medium hover:bg-brand-light transition-colors border border-gray-200"
                            >
                                Змінити пароль
                            </button>
                        </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end">
                        <button
                            onClick={handleSave}
                            disabled={saving}
                            className="flex items-center gap-2 px-6 py-3 bg-brand-primary text-white font-bold rounded-xl hover:bg-brand-secondary transition-colors disabled:opacity-70 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform active:scale-95 duration-200"
                        >
                            {saving ? (
                                <>
